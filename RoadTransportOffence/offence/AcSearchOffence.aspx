<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Finance.Master" AutoEventWireup="true" CodeBehind="AcSearchOffence.aspx.cs" Inherits="RoadTransportOffence.offence.AcSearchOffence" %>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Search Offence</h4>
		    <ol class="breadcrumb">
    ...
    <!-- End Breadcrumb-->
	  ...
	  <div class="row">
	   <div class="col col-lg-12 col-xl-12">
	    <div class="card">
	     <div class="card-header text-uppercase">Search Offence     </div>
        ...
        <div class="panel panel-default" > 
                ...
                <%--    <asp:TextBox ID="txtsearch"   ToolTip="Search by : RefNumber, Module Name etc" 
                        Placeholder="Search" runat="server"  >
                       </asp:TextBox>

                       <span class="input-group-btn">
                     <asp:LinkButton ID="btnSearch" class="btn btn-primary" text="Search" runat="server" OnClick="btnSearch_Click" > </asp:LinkButton>
                       </span>--%>


                      <asp:TextBox ID="Ticketnumber"   ToolTip="Search by : RefNumber, Module Name etc" 
                        Placeholder="TicketNo" runat="server"  >
                       </asp:TextBox>
                                       <asp:TextBox ID="date" runat="server" Visible="false" ></asp:TextBox>
                            <asp:TextBox ID="sum" runat="server" Visible="false" ></asp:TextBox>

                            <asp:TextBox ID="percent" runat="server" Visible="false"></asp:TextBox>

                       <span class="input-group-btn">
                     <asp:LinkButton ID="btnTicket" class="btn btn-primary" text="TicketNo" runat="server" OnClick="btnTicket_Click" > </asp:LinkButton>
                       </span>
                    ...
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="450px">
                        ...
                        <asp:GridView ID="grdItemList" runat="server"  ForeColor="Black" 
                            ...
                            HeaderStyle-BackColor="#6167CA" HeaderStyle-ForeColor="White"  Font-Size="13px" AllowPaging="True" 
                              onpageindexchanging="grdItemList_PageIndexChanging"  ShowFooter="True" >
                          <Columns>
                             ...
                             <asp:LinkButton ID="calculate" class="btn btn-primary" text="Calculate" runat="server" OnClick="btnCalculate_Click" > </asp:LinkButton>
...
<%--                   <asp:Label ID="Label1" class="btn btn-success" Font-Size="16px" runat="server" Text="MANAGE CHECKER INFORMATION"></asp:Label> --%>
                   ...
                   <%-- <div class="col-lg-6">
                          ...
                          <asp:Label ID="Label6" runat="server" Text="Offence Code"></asp:Label><br />
            <asp:TextBox ID="OffenceCo" class="form-control" ForeColor="Black" runat="server"></asp:TextBox>
            <p></p> 
                    </div>--%>
      ...
      <div class="panel-footer">     
                    ...
                    <asp:LinkButton ID="btnUpdate" class="btn btn-labeled btn-success m-b-5" runat="server" OnClick="btnUpdate_Click" > 
                      <span class="btn-label"><i class="fa fa-edit"></i></span> UPDATE OFFENCE.</asp:LinkButton>
...
<asp:Panel ID="pnlpopupDeleteItem"  class="panel panel-primary" runat="server" BackColor="White" style="display:none"  Width="300px"  DefaultButton="btnDeleteItem"> 
  ...
  <hr /> 
   <asp:Label ID="lblCodeDeleteItem" runat="server" Text="0"></asp:Label>. 
    ...
    <asp:Label ID="ticket" runat="server" visible="false"></asp:Label>

    <asp:TextBox ID="ticketno" runat="server" Visible="false"></asp:TextBox>
        <asp:TextBox ID="days" runat="server" Visible="false"></asp:TextBox>
