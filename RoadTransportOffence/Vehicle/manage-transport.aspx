<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="manage-transport.aspx.cs" Inherits="RoadTransportOffence.Vehicle.manage_transport" %>
...
<%--                   <asp:Label ID="Label1" class="btn btn-success" Font-Size="16px" runat="server" Text="MANAGE CHECKER INFORMATION"></asp:Label> --%>
                 ...
                 <div class="col-lg-6">                                       
            <asp:Label ID="Label1" runat="server" Font-Size="11px"   Text="Owner Name"></asp:Label><br />
            <asp:TextBox ID="Name" ForeColor="Black" runat="server"></asp:TextBox><br /> 

            <asp:Label ID="Label3" runat="server" Font-Size="11px" Text=" Phone No"></asp:Label><br />
            <asp:TextBox ID="phone" ForeColor="Black"  runat="server"></asp:TextBox><br /> 

           
            <asp:Label ID="Label4" runat="server" Font-Size="11px" Text="Address"></asp:Label><br />
            <asp:TextBox ID="address" ForeColor="Black"  runat="server"></asp:TextBox><br />   
      ...
      <div class="panel-footer">     
                    ...
                    <asp:LinkButton ID="btnUpdate" class="btn btn-labeled btn-success m-b-5" runat="server" OnClick="btnUpdate_Click" AutoPostBack="true"> 
                      <span class="btn-label"><i class="fa fa-edit"></i></span> UPDATE VEHICLE.</asp:LinkButton>
...
<asp:Panel ID="pnlpopupDeleteItem"  class="panel panel-primary" runat="server" BackColor="White" style="display:none"  Width="300px"  DefaultButton="btnDeleteItem"> 
  <asp:Label ID="Label8" runat="server" class="label label-info" Text="Do you want to Delete this Vehicle ?"> </asp:Label>   
  <hr /> 
