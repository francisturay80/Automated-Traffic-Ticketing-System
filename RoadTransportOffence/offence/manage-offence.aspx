<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="manage-offence.aspx.cs" Inherits="RoadTransportOffence.offence.manage_offence" %>
...
<%--                                        <cc2:BuyNowButton ID="BuyNowButton2" runat="server"></cc2:BuyNowButton>--%>
<%--                                        <cc2:BuyNowButton ID="BuyNowButton1" BusinessEmailOrMerchantID="mansray0@gmail.com" ZIgnore="09/28/2020 23:44:30" runat="server" OnClick="BuyNowButton1_Click" Amount='<%# Convert.ToDecimal(Eval("Cost")) %>' ItemName='<%# Eval("title") %>' ItemNumber="1" ></cc2:BuyNowButton>--%>
...
<%--                   <asp:Label ID="Label1" class="btn btn-success" Font-Size="16px" runat="server" Text="MANAGE CHECKER INFORMATION"></asp:Label> --%>
            ...
            <p></p> 
               ...
               <div class="col-lg-6">
                          <asp:Label ID="Label3" runat="server" Text="Offence Title"></asp:Label><br />
            <asp:TextBox ID="offenceT" class="form-control" ForeColor="Black" runat="server"></asp:TextBox>
            <p></p> 
