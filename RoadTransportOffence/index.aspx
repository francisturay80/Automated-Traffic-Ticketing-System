<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="RoadTransportOffence.index" %>
		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="assets/SLRSAL.png" alt="logo icon" width="200">
		 	</div>
			...
			<div class="form-row">
			 ...
			 <div class="form-group col-6 text-right">
			  <a href="authentication-reset-password.html">Reset Password</a>
				...
				<asp:Button  ID="btnSubmit" runat="server" Text="LOGIN" class="btn btn-primary btn-block" OnClick="btnSubmit_Click" />
