            ...
            {
                {
                    ...
                    cmd.Connection = con;
                    cmd.Parameters.AddWithValue("@UserID", Username.Text.Trim());
                    //
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (status == 0)
                        {
                            ...
                            if (userid == Username.Text.Trim() && RoleType == "Admin")
                        {
                            ...
                            Session.Add("Session", Email);

                            lblMsg.Text = "Login successful.";

                            Response.Cookies["InventMgtCookies"]["UserID"] = UserID;
                            Response.Cookies["InventMgtCookies"]["Email"] = Email;
                        ...
                        if (userid == Username.Text.Trim() && RoleType == "Accountant")
                        {
                            Session["Fname"] = userlog;
                            Session["UserID"] = userid;
                            Session["LName"] = useLastName;
                            ...
                            Response.Redirect("Dashboard/FinanceDashboard.aspx", false);
                            Response.Redirect("~/Dashboard/FinanceDashboard.aspx");
